        ...
        <div className='flex flex-col xl:flex-row gap-24'>
          ...
          <div className='flex flex-col items-center text-center lg:items-start lg:text-left'>
            <div className='flex flex-col'>
              <h3 className='text-4xl font-extrabold text-accent mb-5'>

                ABOUT
              </h3>
              <h2 className=' sm:text-4xl sm:font-extrabold lg:font-medium lg:text-lg pb-4 relative before:absolute before:opacity-40 before:-top-[2rem] before:hidden before:lg:block'>
                Motunrayo Idowu
              </h2>
              <p className='mb-4 pb-3 text-accent'>
